package com.ftoul.app.action.afterService;
 ...
 *
 */
@Controller("AfterServiceAppAction")
@RequestMapping(value = "/app/afterService")
public class AfterServiceAppAction {

	@Autowired
	private AfterServiceServ afterServiceServ;
	@Autowired
	private AfterServiceAppServ afterServiceAppServ;
	...
	public @ResponseBody Result getAfterListByUserId(String param) throws Exception{
		...
		return afterServiceAppServ.getAfterListByUserId(parameter);
	}
	...
	public @ResponseBody Result getAfterSchedulePage(String param) throws Exception{
		Parameter parameter = Common.jsonToParam(param);
		return afterServiceAppServ.getAfterSchedulePage(parameter);
	}
	...
	public @ResponseBody Result getAfterSchedule(String param) throws Exception{
		Parameter parameter = Common.jsonToParam(param);
		return afterServiceAppServ.getAfterSchedule(parameter);
	}
