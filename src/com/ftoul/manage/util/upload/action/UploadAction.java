...
public class UploadAction {
	...
	public @ResponseBody Result upload(@RequestParam MultipartFile[] pic ,HttpServletRequest request,HttpServletResponse response) throws Exception{
	...
	public @ResponseBody Result pictureFileUpload(String param ,HttpServletRequest request) throws Exception{
	...
	public @ResponseBody Result goodsPicUpload(String param, HttpServletRequest request) throws Exception{
		Parameter parameter = Common.jsonToParam(param);
	...
	public @ResponseBody Result advertPicUpload(String param, HttpServletRequest request) throws Exception{
		Parameter parameter = Common.jsonToParam(param);
