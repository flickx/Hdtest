package com.ftoul.businessManage.shopCoupon.action;
 ...
 *
 */
@Controller("ShopCouponAction")
@RequestMapping(value = "/businessManage/shopCoupon")
public class ShopCouponAction {
	
	@Autowired
	private ShopCouponServ couponService;
