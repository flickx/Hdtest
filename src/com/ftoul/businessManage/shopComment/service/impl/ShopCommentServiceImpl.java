package com.ftoul.businessManage.shopComment.service.impl;
...
import com.ftoul.businessManage.shopComment.vo.ShopGoodsCommentVo;
...
public class ShopCommentServiceImpl implements ShopCommentServ {
	...
	public Result getCommentPage(Parameter param) throws Exception {
		...
		String hql;
		if(whereStr!=null){
			hql = "from GoodsComment where state = '1' and ordersDetail.shopId='"+param.getManageToken().getBusinessStoreLogin().getBusinessStore().getId()+"' and"+whereStr+" order by commentTime desc";
		}else{
			hql = "from GoodsComment where state = '1' and ordersDetail.shopId='"+param.getManageToken().getBusinessStoreLogin().getBusinessStore().getId()+" order by commentTime desc";
		}
		...
		for (Object object : objList) {
			...
			ShopGoodsCommentVo vo = new ShopGoodsCommentVo();
