...
public class WeiXinAppPayUtil {
	 ...
	 */
	public Map<String,Object> payByOrders(Orders orders,String ipAddress) throws Exception{
...
//		parameters.put("timeStamp", new Date().getTime()+"");
		...
		String newSign="appid="+ConfigUtil.APPID+"&noncestr="+nonceStr+"&package=Sign=WXPay"+"&partnerid="+
...
//		return map;
	    ...
	    resMap.put("wxpackage", "Sign=WXPay");
...
//	    json.append(newSign);
//	    json.append("\"}");
//	    System.out.println("微信json:"+json.toString());
	    return resMap;
